    ...
    return (
        <>  
            <div className='flex  justify-between'>
                <div className="w-full max-w-sm bg-white border flex justify-center flex-col items-center border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
